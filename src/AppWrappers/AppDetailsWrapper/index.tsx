...
import { ADD_APPLICATION } from '../../redux/action';
import { useDispatch } from "react-redux";
import { fetcher } from '../../ApiService';
import { API_URL } from '../../constants';


const AppDetailsWrapper = (props: any) => {
    ...
    const fetchApplicationDetails = async () => {
        const autoResults: any = await fetcherService({ apiUrl: API_URL.APPLICATION_DETAILS });
        ...
        return (
            <div className="bg-gray-100 flex items-center justify-center h-screen">
                <div className="max-w-lg w-full bg-white p-8 rounded-lg shadow-lg text-center">
                    ...
                    <p className="text-lg text-gray-700 mb-4">Something went wrong, No Applications Found !!!</p>
                </div>
            </div>
        )
    }
